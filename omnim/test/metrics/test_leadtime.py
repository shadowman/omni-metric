...
class LeadTimeCalculatorTests(unittest.TestCase):
    ...
    def test_it_should_return_average_leadtime_of_event_stream_in_delta_type(self):  # noqa: E501
    ...
    def test_it_should_return_average_leadtime_from_successful_build_to_successful_deploy(self):  # noqa: E501
        metric = LeadtimeMetricCalculator()
        today = datetime.datetime.today()
        events_stream = (
            WorkflowEvent(today, "build_success"),
    ...
    def test_it_should_not_return_an_average_if_no_successful_deploy_is_found(self):  # noqa: E501
        metric = LeadtimeMetricCalculator()
        today = datetime.datetime.today()
        events_stream = (
            WorkflowEvent(today, "build_success"),
    ...
    def test_it_should_not_return_an_average_if_build_is_not_successful_and_deploy_succeeded(self):  # noqa: E501
        metric = LeadtimeMetricCalculator()
        today = datetime.datetime.today()
        events_stream = (
            WorkflowEvent(today, "build_failed"),
    ...
    def test_it_should_return_an_average_if_more_than_one_successful_build(self):  # noqa: E501
        metric = LeadtimeMetricCalculator()
        today = datetime.datetime.today()
        events_stream = (
            WorkflowEvent(today, "build_success"),
    ...
    def test_it_should_only_look_at_events_from_the_same_pipeline_execution(self):  # noqa: E501
        metric = LeadtimeMetricCalculator()
        today = datetime.datetime.today()
        events_stream = (
            WorkflowEvent(
            ...
            WorkflowEvent(
                today + timedelta(seconds=40),
                "deploy_success",
                "pipeline_id1"
            ),
            WorkflowEvent(
                today + timedelta(seconds=60),
                "deploy_success",
                "pipeline_id2"
            )
        )
